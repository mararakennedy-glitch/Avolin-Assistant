...
import type { CreateOpenaiConversationBody, GenerateOpenaiImageBody, GenerateOpenaiImageResponse, HealthStatus, OpenaiConversation, OpenaiConversationWithMessages, OpenaiError, OpenaiMessage, OpenaiTtsBody, OpenaiTtsResponse, SendOpenaiMessageBody, SendOpenaiVoiceMessageBody } from "./api.schemas";
 ...
 */
export declare const getSendOpenaiVoiceMessageUrl: (id: number) => string;
export declare const sendOpenaiVoiceMessage: (id: number, sendOpenaiVoiceMessageBody: SendOpenaiVoiceMessageBody, options?: RequestInit) => Promise<unknown>;
export declare const getSendOpenaiVoiceMessageMutationOptions: <TError = ErrorType<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof sendOpenaiVoiceMessage>>, TError, {
        id: number;
        data: BodyType<SendOpenaiVoiceMessageBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationOptions<Awaited<ReturnType<typeof sendOpenaiVoiceMessage>>, TError, {
    id: number;
    data: BodyType<SendOpenaiVoiceMessageBody>;
}, TContext>;
export type SendOpenaiVoiceMessageMutationResult = NonNullable<Awaited<ReturnType<typeof sendOpenaiVoiceMessage>>>;
export type SendOpenaiVoiceMessageMutationBody = BodyType<SendOpenaiVoiceMessageBody>;
export type SendOpenaiVoiceMessageMutationError = ErrorType<unknown>;
/**
 * @summary Send audio and receive a streaming voice response
 */
export declare const useSendOpenaiVoiceMessage: <TError = ErrorType<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof sendOpenaiVoiceMessage>>, TError, {
        id: number;
        data: BodyType<SendOpenaiVoiceMessageBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationResult<Awaited<ReturnType<typeof sendOpenaiVoiceMessage>>, TError, {
    id: number;
    data: BodyType<SendOpenaiVoiceMessageBody>;
}, TContext>;
/**
 ...
 */
export declare const getOpenaiTextToSpeechUrl: () => string;
export declare const openaiTextToSpeech: (openaiTtsBody: OpenaiTtsBody, options?: RequestInit) => Promise<OpenaiTtsResponse>;
export declare const getOpenaiTextToSpeechMutationOptions: <TError = ErrorType<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof openaiTextToSpeech>>, TError, {
        data: BodyType<OpenaiTtsBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationOptions<Awaited<ReturnType<typeof openaiTextToSpeech>>, TError, {
    data: BodyType<OpenaiTtsBody>;
}, TContext>;
export type OpenaiTextToSpeechMutationResult = NonNullable<Awaited<ReturnType<typeof openaiTextToSpeech>>>;
export type OpenaiTextToSpeechMutationBody = BodyType<OpenaiTtsBody>;
export type OpenaiTextToSpeechMutationError = ErrorType<unknown>;
/**
 * @summary Convert text to speech audio
 */
export declare const useOpenaiTextToSpeech: <TError = ErrorType<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof openaiTextToSpeech>>, TError, {
        data: BodyType<OpenaiTtsBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationResult<Awaited<ReturnType<typeof openaiTextToSpeech>>, TError, {
    data: BodyType<OpenaiTtsBody>;
}, TContext>;
/**
...
export declare const generateOpenaiImage: (generateOpenaiImageBody: GenerateOpenaiImageBody, options?: RequestInit) => Promise<GenerateOpenaiImageResponse>;

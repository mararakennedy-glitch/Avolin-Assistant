 ...
 * audio itself.
 */
export declare function speechToText(audioBuffer: Buffer, format?: "wav" | "mp3" | "webm", language?: string): Promise<string>;
/** Streaming Speech-to-Text. */
export declare function speechToTextStream(audioBuffer: Buffer, format?: "wav" | "mp3" | "webm", language?: string): Promise<AsyncIterable<string>>;
